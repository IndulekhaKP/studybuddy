...
- Wallpaper background: light mode picks a random image from `day wallapapers/` and night mode picks from `night wallapapers/`, both with preserved aspect ratio
